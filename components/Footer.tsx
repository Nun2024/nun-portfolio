    ...
    <footer className="relative bg-zinc-950 border-t border-white/10 overflow-hidden">
      ...
      <Container>
        <div className="relative z-10 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-white">Sian Nun</span>
              </div>
              <p className="text-zinc-400 text-sm">
                Building fast, accessible, and beautiful web experiences with modern technologies.
              </p>
            </motion.div>
          ...
          >
            <p>
              © {currentYear} Sian Nun. All rights reserved.
            </p>
